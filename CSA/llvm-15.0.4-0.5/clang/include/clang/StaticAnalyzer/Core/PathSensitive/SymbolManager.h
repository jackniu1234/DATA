...
public:
  ...
  void customDumpToStream(raw_ostream& os) const override;
...
protected:
  ...
  static void customDumpToStreamImpl(raw_ostream &os, const SymExpr *Value);
  static void customDumpToStreamImpl(raw_ostream &os, const llvm::APSInt &Value);
};
