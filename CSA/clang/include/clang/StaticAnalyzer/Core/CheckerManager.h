...
public:
  ...
  CheckerBase* getCheckerBase() { return Checker; }
};
...
//===----------------------------------------------------------------------===//
  ...
  /// Run checkers for processing summary
  ...
  void runCheckersForCustomDumpToStream(raw_ostream &Out, ProgramStateRef State) const;
...
//===----------------------------------------------------------------------===//
  ...
  using EvalSummaryApplyFunc = CheckerFn<void (const CallEvent&, CheckerContext&, void*)>;
